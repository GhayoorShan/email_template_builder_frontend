      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            onChange={(e) => onUpdate({ alignment: e.target.value as SocialMediaComponent['alignment'] })}
          ...
          {component.icons.map((icon, index) => (
            <div key={index} className="p-3 border rounded-md">
              ...
              <div className="space-y-2">
                <select
                  value={icon.platform}
                  onChange={(e) => updateIcon(index, { platform: e.target.value as SocialMediaComponent['icons'][0]['platform'] })}
